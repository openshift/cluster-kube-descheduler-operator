...
$ opm alpha convert-template basic -o yaml ./catalog-migrate/cluster-kube-descheduler-operator/catalog.json > v4.15/catalog-template.yaml
```
...
$ opm alpha render-template basic v4.15/catalog-template.yaml > v4.15/catalog/cluster-kube-descheduler-operator/catalog.json
```
