...
$ opm alpha convert-template basic -o yaml ./catalog-migrate/cluster-kube-descheduler-operator/catalog.json > v4.17/catalog-template.yaml
```
...
$ opm alpha render-template basic v4.17/catalog-template.yaml --migrate-level bundle-object-to-csv-metadata > v4.17/catalog/cluster-kube-descheduler-operator/catalog.json
```
