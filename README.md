...
| kdo version   | ocp version | k8s version | golang | release branch |
| ------------- | ----------- | ----------- | ------ | -------------- |
| 4.12.1        | 4.12        | 1.25        | 1.19   | 4.12           |
| 4.13.1        | 4.13        | 1.26        | 1.19   | 4.13           |
| 4.14.1-4.14.3 | 4.14        | 1.27        | 1.20   | 4.14           |
| 4.14.4        | 4.14        | 1.27        | 1.20   | 4,14           |
| 5.0.0         | 4.15, 4.16  | 1.28        | 1.20   | 4.16           |
| 5.0.1-5.0.5   | 4.15, 4.16  | 1.29        | 1.21   | 4.16           |
| 5.0.6         | 4.15, 4.16  | 1.29        | 1.21   | 4.16           |
| 5.1.0         | 4.17, 4.18  | 1.30        | 1.22   | 4.18           |
| 5.1.1-5.1.5   | 4.17, 4.18  | 1.31        | 1.22   | 4.18           |
| 5.1.6         | 4.17, 4.18  | 1.31        | 1.22   | 4.18           |
| 5.2.0         | 4.19, 4.20  | 1.32        | 1.23   | 4.19           |
| 5.2.1-5.2.2   | 4.19, 4.20  | 1.32        | 1.23   | 4.19           |
| 5.2.3         | 4.19, 4.20  | 1.32        | 1.23   | 4.19           |
| 5.3.0-5.3.1   | 4.20, 4.21  | 1.33        | 1.24   | 4.21           |
| 5.3.2-5.3.3   | 4.20, 4.21  | 1.34        | 1.24   | 4.21           |
| 5.3.4         | 4.20, 4.21  | 1.34        | 1.24   | 4.21           |
| 5.4.0-5.4.2   | 4.22, 4.23  | 1.35        | 1.25   | 4.22           |
| 5.4.3         | 4.22, 4.23  | 1.35        | 1.25   | 4.22           |
...
1. Build a custom FBC (File-Based Catalog) via a PR against the `fbc` branch by extending either of the existing catalogs. Access the FBC pull Konflux job to get the FBC image.

1. Create and apply catalogsource manifest (remember to change 4-22 and <sha> to the right values):
   ```yaml
   ...
   spec:
     sourceType: grpc
     image: quay.io/redhat-user-workloads/kdo-workloads-tenant/kube-descheduler-operator-fbc-4-22:on-pr-<sha>
   ```
