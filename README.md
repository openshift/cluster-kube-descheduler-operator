...
$ opm alpha convert-template basic -o yaml ./catalog-migrate/cluster-kube-descheduler-operator/catalog.json > v4.16/catalog-template.yaml
```
...
$ opm alpha render-template basic v4.16/catalog-template.yaml > v4.16/catalog/cluster-kube-descheduler-operator/catalog.json
```
